    ...
    if (!empty($_POST['username']) && !empty($_POST['password'])) {
        ...
        if (mysqli_num_rows($check_username) == 1) {
            ...
            if (mysqli_num_rows($check_userpass) == 1) {
                ...
                $_SESSION['loginMSG'] = "ผิดพลาด! ชื่อบัญชีหรือรหัสผ่านไม่ถูกต้อง";
    ...
    <body class="login">
        ...
        <div class="content">
            <form class="login-form" action="login.php" method="post">
                <h3 class="form-title" style="margin:0 -20px 15px 0;">เข้าสู่ระบบ</h3>
                ...
                <div class="form-group">
                    ...
                    <label class="control-label visible-ie8 visible-ie9">ชื่อบัญชี</label>
                    <div class="input-icon">
                        <i class="icon-user"></i>
                        <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="ชื่อบัญชี" name="username"/>
                    </div>
                </div>
                <div class="form-group">
